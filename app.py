...
# 📌 ฟังก์ชันตั้งค่า Sidebar แบบสตริงธรรมดา (ตัด f ออก ป้องกัน Error ขาดรอมร่อ)
...
# 2. แปลงรูปภาพ bg_lotus.jpg ให้แสดงผลเป็นพื้นหลังตรงกลาง
...
# 3. ปรับแต่ง CSS หลักของหน้าเว็บ (แสดงภาพพื้นหลังดอกบัวสวยๆ)
st.markdown(f"""
    <style>
    html, body {{
